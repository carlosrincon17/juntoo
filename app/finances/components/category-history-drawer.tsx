...
import { getCategoryExpensesDetail } from "@/app/actions/expenses"
...
export default function CategoryHistoryDrawer({ isOpen, onOpenChange, categoryName, filters }: CategoryHistoryDrawerProps) {
    ...
    useEffect(() => {
        if (isOpen && categoryName) {
            const fetchHistory = async () => {
                setIsLoading(true)
                try {
                    const data = await getCategoryExpensesDetail(categoryName, filters)
                    ...
                    <div className="flex justify-between items-center p-4 border-b">
                        <div className="flex flex-col gap-1">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-xl font-bold">Historial de Categoría</h2>
                            </div>
                        ...
                        <div className="p-6">
                            {isLoading ? (
                                ...
                                <div className="text-center py-10 text-gray-500">
                                    No hay movimientos registrados para esta categoría en el rango seleccionado.
                                </div>
                            ) : (
