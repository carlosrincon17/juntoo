...
export const NavTitle = () => {
    return (
        <div className="flex justify-between items-center gap-x-1">
            <div className="flex font-light justify-between items-center text-xl text-black focus:outline-none focus:opacity-80 dark:text-white">
                <Image src="/juntoo.webp" className="h-6" alt="juntoo" />
            </div>
